...
class TestDatabase:
    ...
    def test_available_buns_return_expected_buns_list(self, database):
    ...
    def test_available_ingredients_return_expected_ingredients_list(self, database):
    ...
    def test_available_buns_return_default_buns_list(self, database):
    ...
    def test_available_ingredients_return_default_buns_list(self, database):
        with allure.step('Проверяем, что возвращается значение по умолчанию'):
